 ...
 *  2. 🛒 Dynamic Cart       : Counter keranjang belanja real-time dengan efek visual.
 *  3. 🏎️ Product Slider     : Integrasi Swiper.js untuk showcase produk yang responsif.
 *  4. 🚚 Truck Animation    : Button 'Add to Cart' unik dengan animasi truk pengiriman (GSAP).
 *  5. 🎭 Scroll Animation   : Efek fade-in saat scroll menggunakan library AOS.
 *  6. ⚡ Performance        : Optimasi event listener dan layout thrashing minimal.
