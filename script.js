...
// Logika untuk memperbarui tahun di copyright secara otomatis
...
var aosOffset = 100; // Default untuk desktop
var aosDuration = 1000; // Default duration untuk desktop

// Jika layar kurang dari 768px (ukuran tablet/mobile)
if (screenWidth < 768) {
    aosOffset = 50; 
    aosDuration = 800; // Percepat sedikit durasi agar terasa lebih responsif di HP
}
...
// Logika untuk memperbaru saat ukuran jendela berubah
